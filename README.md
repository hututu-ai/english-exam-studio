...
- **先选本次范围**：安装后或第一次调用时，助手会问“整卷／指定板块／精听”；你已说明范围就直接开始。可选择阅读 A、C，或只做听力 Text 6，不必每次生成整卷。
- **速对答案**：顶部查看本节或全部客观题与填空答案，逐题揭示／批量揭示、遮住、跳回讲评；显示答案来源，不影响原来的逐题解析。
...
```text
只做听力 Text 6、7 的精听课件，保留原卷题目、整段和逐题录音，打开后默认显示原文与关键表达挖空。
```
