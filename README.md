...
主课件服务老师备课和讲评。学生需要完成的仿写与补充练习放在独立的 `worksheet.html` 学案里，老师可按章节选择打印。
...
```text
请使用英语实战讲评 Skill（english-exam-studio），根据我提供的试卷、参考答案、听力音频及已有听力原文，制作完整的教师用 HTML 讲评课件和配套学生学案。
...
4. 沿用简洁的教师工作区，不额外堆重复入口。主课件服务老师讲评，学生练习放在独立学案。
5. 完成后核对题目覆盖、答案依据、听力对应、课堂交互与文件完整性，说明仍需核对的具体位置。

请提供 index.html、worksheet.html、可编辑 exam.json、完整课件文件夹及 ZIP，并告诉我如何打开和保存课堂记录。
```
