...
新版先检查电脑或 Agent 已有的工具，不要求每次重新安装。遇到 GitHub/代理 502，不无限换源等待；安装尝试设置总时限，失败后继续文字板块，听力可接完整原音并明确标注未分段。等环境补齐后只补听力，不重做整卷。详见 [下载失败处理](references/dependency-recovery.md)。
